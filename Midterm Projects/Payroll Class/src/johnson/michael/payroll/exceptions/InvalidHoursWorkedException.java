...
public class InvalidHoursWorkedException extends IllegalArgumentException {
  /**
   * Constructs an <code>InvalidHoursWorkedException</code> with no detail message.
   */
  public InvalidHoursWorkedException() {}

  /**
   * Constructs an <code>InvalidHoursWorkedException</code> with the specified detail message.
   *
   * @param s the detail message.
   */
  public InvalidHoursWorkedException(final String s) {
    super(s);
  }
   ...
   * @since 1.5
   */
  public InvalidHoursWorkedException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.5
   */
  public InvalidHoursWorkedException(final Throwable cause) {
    super(cause);
  }
}
