...
public class EmptyNameException extends IllegalArgumentException {
  /**
   * Constructs an <code>EmptyNameException</code> with no detail message.
   */
  public EmptyNameException() {}

  /**
   * Constructs an <code>EmptyNameException</code> with the specified detail message.
   *
   * @param s the detail message.
   */
  public EmptyNameException(final String s) {
    super(s);
  }
   ...
   * @since 1.5
   */
  public EmptyNameException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.5
   */
  public EmptyNameException(final Throwable cause) {
    super(cause);
  }
}
