...
public class InvalidEmployeeIdException extends IllegalArgumentException {
  /**
   * Constructs an <code>InvalidEmployeeIdException</code> with no detail message.
   */
  public InvalidEmployeeIdException() {}

  /**
   * Constructs an <code>InvalidEmployeeIdException</code> with the specified detail message.
   *
   * @param s the detail message.
   */
  public InvalidEmployeeIdException(final String s) {
    super(s);
  }
   ...
   * @since 1.5
   */
  public InvalidEmployeeIdException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.5
   */
  public InvalidEmployeeIdException(final Throwable cause) {
    super(cause);
  }
}
